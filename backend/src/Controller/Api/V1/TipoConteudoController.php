...
use App\Service\TipoConteudo\TipoConteudoService;
...
#[Route('/api/v1/tipos-conteudo')] #[OA\Tag(name: 'Tipos de conteúdo')]
final readonly class TipoConteudoController
{
    public function __construct(private TipoConteudoService $service, private ValidatorInterface $validator) {}
    ...
    private function dto(Request $request): SalvarTipoConteudoDto
    {
        ...
        $dto = SalvarTipoConteudoDto::deArray(is_array($dados) ? $dados : []); $erros = $this->validator->validate($dto);
